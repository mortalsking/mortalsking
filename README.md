...
* **Description:** A Python-based automation script designed to streamline GitHub repository commits directly from the terminal.
* **Tech:** Python, Git

#### 2. Link Storage Chrome Extension
* **Description:** A lightweight browser extension built to seamlessly store and organize web tab links into specific containers.
* **Tech:** HTML, CSS, JavaScript

#### 3. Student Schedule Automator
* **Description:** An automation project to manage daily routines, digital distractions, and academic scheduling.
* **Tech:** Python

---
⭐️ *Built with Markdown*
